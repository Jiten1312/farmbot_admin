                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: SizedBox(
                                    child: Text(list[index].response))),
                          ],
                        ),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child:
                                    SizedBox(child: Text(list[index].sector))),
                          ],
                        ),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child:
                                    SizedBox(child: Text(list[index].state))),
                          ],
                        ),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child:
                                    SizedBox(child: Text(list[index].block))),
                          ],
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.end,
